<template>
  <v-app>
    <v-app-bar
      style="position: fixed; top: 0; width: 100%; z-index: 1004"
      elevation="2"
      color="primary"
      density="compact"
    >
      ...
      >
        <v-avatar
          image="/images/KangkungAI.png"
          size="40"
          class="mr-4 avatar-border"
        ></v-avatar>
    ...
    <v-main
      class="ml-auto mr-auto w-90 w-lg-75"
      style="padding-top: 60px; padding-bottom: 60px"
    >
      <router-view />
    </v-main>
    <v-footer
      style="bottom: 0; width: 100%; z-index: 1005"
